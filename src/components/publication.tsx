import type { AcademicPaperKind, AcademicPublication, NormalPublication } from "@/data/publication";
...
const AcademicPublicationCard = ({
  ...
  return (
    <section
      className={"inline-flex flex-col gap-2 mb-4"}
    >
      <button
        type="button"
    ...
    >
      ...
      <div className="grid grid-cols-1">
        {Object.entries(Object.groupBy(publicationList, (x) => x.year))
          .toSorted(([year1,], [year2,]) => (year2 as unknown as number) - (year1 as unknown as number))
          .map(([year, publications]) => (
            <div key={year} className="grid grid-cols-8 gap-2 px-5">
              ...
              <div className="col-span-6 flex flex-col gap-4">
                {(publications ?? []).map((publication) => {
                  return match(publication)
                    .with({ __typename: "AcademicPublication" }, (publication) => (
                    ...
                    .with({ __typename: "NormalPublication" }, (publication) => <NormalPublicationCard
